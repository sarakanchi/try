...
if(expirydate>today):
    ...
    if (now>First and now<Firstend):
        ...
        print("29th Oct 2023, 11:00 AM- 11:30 AM")
        print("29th Oct 2023, 02:00 PM- 02:30 PM")
        print("29th Oct 2023, 05:00 PM- 05:30 PM")
        print("29th Oct 2023, 08:00 PM- 08:30 PM")
    ...
    while(True):
        ...
        if(bhai==code):
            clear()
            print("----------Your play time-----------")
            print("10th Oct 2023, 02:30 PM- 03:00 PM")
            print("10th Oct 2023, 05:30 PM- 06:00 PM")
            print("10th Oct 2023, 08:30 PM- 09:00 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
            ...
            system(banner)
            print("----------Your play time-----------")
            print("11th Oct 2023, 04:00 PM- 04:30 PM")
            print("11th Oct 2023, 06:00 PM- 06:30 PM")
            print("11th Oct 2023, 08:00 PM- 08:30 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
